...
export declare class ForecastCalculationService {
    ...
    constructor(supabaseService: SupabaseService, dataIntakeService: DataIntakeService, forecastService: ForecastService, forecastNodeService: ForecastNodeService, forecastEdgeService: ForecastEdgeService);
    calculateForecast(forecastId: string, userId: string): Promise<ForecastCalculationResultDto>;
    ...
    getLatestCalculationResults(forecastId: string, userId: string): Promise<ForecastCalculationResultDto | null>;
    getCalculationHistory(forecastId: string, userId: string): Promise<ForecastCalculationResultDto[]>;
